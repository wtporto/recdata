...
public class Constantes {
	...
	public static String MSG_ErroCampoItemInvalido = "DescriÁ„o do Item n„o preenchida!";
	...
	public static String MSG_ErroCampoDataInicioDepois = "Data Inicio ApÛs a da Final!";
