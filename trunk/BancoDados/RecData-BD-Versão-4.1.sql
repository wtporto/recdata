...
CREATE TABLE IF NOT EXISTS tb_item (
  ...
  nm_item varchar(60) NOT NULL, -- Antiga descri��o;
  dt_registro timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (cd_item),
...
CREATE TABLE IF NOT EXISTS tb_devolucao (
  ...
  cd_reserva int(11) NOT NULL,
  cd_usuario_recebimento int(11) NOT NULL, -- Usu�rio que recebe o item devolvido.
  cd_usuario_devolucao int(11) NOT NULL, -- Usu�rio que devolve o item. 
...
CREATE TABLE IF NOT EXISTS tb_tipousuario (
  ...
  nm_tipousuario varchar(40) NOT NULL, -- Antigo descri��o.
